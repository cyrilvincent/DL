...
def save_bottlebeck_features():
    ...
    np.save(open('../data/dogsvscats/vgg16-bottleneck-train.npy', 'wb'),
            bottleneck_features_train)
    np.savetext(open('data/dogsvscats/vgg16-bottleneck-train.csv', 'w'),
    ...
    np.save(open('../data/dogsvscats/vgg16-bottleneck-validation.npy', 'wb'),
            bottleneck_features_validation)
    np.savetext(open('data/dogsvscats/vgg16-bottleneck-validation.csv', 'w'),
                bottleneck_features_train, delimiter=",", newline="\n")


def train_top_model():
    train_data = np.load(open('../data/dogsvscats/vgg16-bottleneck-train.npy', 'rb'))
    ...
    validation_data = np.load(open('../data/dogsvscats/vgg16-bottleneck-validation.npy', 'rb'))
