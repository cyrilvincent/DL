...
model = applications.vgg16.VGG16(include_top=False, weights=None, input_shape = (img_width,img_height,3))
print(model.summary())
...
checkpointer = ModelCheckpoint(filepath = 'wafer/t0-ckpt-{epoch:03d}-{val_accuracy:.3f}.h5',
